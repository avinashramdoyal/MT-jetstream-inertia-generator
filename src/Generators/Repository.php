<?php namespace innovmt\MTJetstreamInertiaGenerator\Generators;

use Doctrine\DBAL\Schema\ForeignKeyConstraint;
use innovmt\MTJetstreamInertiaGenerator\Generators\Traits\FileManipulations;
...
class Repository extends ClassGenerator {
    ...
    /**
     * model can have a custom primary key
     *
     * @return mixed
     */
    protected string $customPrimaryKey = '';
    ...
    public function handle()
    {
        ...
        if(!empty($customPrimaryKey = $this->option('primary-key'))) {
    ...
    protected function getOptions() {
        return [
            ['primary-key', 'pk', InputOption::VALUE_OPTIONAL, 'Specify custom primary key'],
