<?php namespace innovmt\MTJetstreamInertiaGenerator\Generators\Traits;

use innovmt\MTJetstreamInertiaGenerator\Generators\Controller;
use innovmt\MTJetstreamInertiaGenerator\Generators\Model;
